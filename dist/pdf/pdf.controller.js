...
let PdfController = class PdfController {
    pdfService;
    tempFolder = path.join(process.cwd(), 'temp-pdfs');
    ...
    downloadFile(fileName, res) {
        ...
        if (!fs.existsSync(filePath)) {
            throw new common_1.InternalServerErrorException('File not found. It may have expired.');
        }
...
], PdfController.prototype, "exportPdf", null);
__decorate([
...
], PdfController.prototype, "downloadFile", null);
